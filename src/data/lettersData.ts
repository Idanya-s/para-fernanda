...
export const lettersData: Letter[] = [
  {
    ...
    styleName: 'Amor Eterno & Sublime',
    envelopeBg: 'from-zinc-900 to-stone-955 border-stone-800 text-stone-300',
    sealBg: 'bg-rose-950 shadow-red-950/50',
    sealSymbol: '🐦‍⬛',
    sealColor: '#450a0a',
    title: 'Anabel en el Viento',
    quote: '"Amamos con un amor que era más que amor, un lazo que ni los ángeles del cielo podrían desatar."',
    poem: [
      'Ni la distancia, ni el tiempo, ni las brumas del mar',
      'podrán apagar la llama de tu dulce mirar.',
      'Tu alma es el faro que guía mi noche oscura,',
  ...
  },
  {
    ...
    styleName: 'Devoción Íntima & Estelar',
    envelopeBg: 'from-neutral-900 to-slate-950 border-slate-900 text-slate-300',
    sealBg: 'bg-indigo-950 shadow-indigo-950/50',
    sealSymbol: '🥀',
    sealColor: '#1e1b4b',
    title: 'La Ceremonia de tus Ojos',
    quote: '"Tú eres mi noche, mi vigilia, el único idioma en el que mi alma sabe pronunciar la palabra felicidad."',
    poem: [
      'Nombrar tu risa es fundar un reino de luz.',
      'Tus manos son mi patria, mi tregua, mi cruz.',
      'Escribo en el viento lo mucho que te quiero,',
  ...
  },
  {
    ...
    styleName: 'Cómplice & Cotidiano',
    envelopeBg: 'from-amber-950 to-orange-950 border-orange-900/40 text-amber-100',
    sealBg: 'bg-red-800 shadow-red-800/50',
    sealSymbol: '☕',
    sealColor: '#991b1b',
    title: 'Táctica de un Amor Infinito',
    quote: '"Mi táctica es mirarte, aprender cómo eres, quererte como eres, y que no te quedes nunca con dudas."',
    poem: [
      'Mi estrategia hoy es amarte sin medidas,',
      'encontrar en tu abrazo la cura de mis heridas.',
      'Caminar de tu mano por calles y avenidas,',
  ...
  },
  {
    ...
    styleName: 'Delicado & Infinito',
    envelopeBg: 'from-stone-100 to-amber-100 border-amber-200 text-stone-700',
    sealBg: 'bg-emerald-800 shadow-emerald-800/40',
    sealSymbol: '🌸',
    sealColor: '#065f46',
    title: 'La Flor del Alma',
    quote: '"El amor es anterior a la vida, posterior a la muerte, inicial de la creación y exponente de la tierra."',
    poem: [
      'Si una rosa pudiera hablar de tu hermosura,',
      'se inclinaría rendida ante tanta dulzura.',
      'Un año es solo un pétalo de tu flor eterna,',
  ...
  },
  {
    ...
    styleName: 'Mágico & Destinado',
    envelopeBg: 'from-emerald-950 to-teal-950 border-emerald-900 text-emerald-100',
    sealBg: 'bg-green-700 shadow-green-700/50',
    sealSymbol: '🦎',
    sealColor: '#15803d',
    title: 'La Coincidencia de dos Almas',
    quote: '"Estábamos allí sin buscarnos, pero sabiendo que nos buscábamos para encontrarnos."',
    poem: [
      'Jugar a querernos y ganar la partida,',
      'encontrar en tu boca el mapa de la vida.',
      'Me gustas despeinada, libre, encendida,',
  ...
  },
  {
    ...
    styleName: 'Romántico & Apasionado',
    envelopeBg: 'from-stone-900 to-yellow-950 border-amber-800/30 text-amber-200',
    sealBg: 'bg-amber-700 shadow-amber-700/50',
    sealSymbol: '🌟',
    sealColor: '#b45309',
    title: 'Tu Rima Favorita',
    quote: '"¿Qué es poesía? ¿Y tú me lo preguntas? Poesía... eres tú."',
    poem: [
      'Podrá apagarse el sol para siempre jamás,',
      'podrá secarse el mar en un breve instante,',
      'pero nunca en mi alma se apagará jamás',
  ...
  },
  {
    id: 'neruda',
    author: 'Pablo Neruda',
    styleName: 'Sensual & Terrenal',
    envelopeBg: 'from-sky-950 to-blue-950 border-blue-900 text-sky-100',
    sealBg: 'bg-cyan-800 shadow-cyan-800/50',
    sealSymbol: '⛵',
    sealColor: '#075985',
...
export const finalLetterContent = {
  title: 'Para Fernanda, desde mi corazón',
  quote: '"El amor no conoce distancias; no tiene continentes; sus ojos miran las estrellas."',
  content: [
    'Hoy el mundo está de fiesta, porque un día como hoy llegaste tú. Feliz cumpleaños, Fernanda.',
    '',
